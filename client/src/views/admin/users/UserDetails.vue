...
import UserInfo from './components/user-details/UserInfo.vue'
import UserHistoryPlaceholder from './components/user-details/UserHistoryPlaceholder.vue'
import UserIssuePlaceholder from './components/user-details/UserIssuePlaceholder.vue'
